    ...
    public class Loader
    {
        ...
        public List<Ressource> LoadProfil()
        {
            ...
            while (i < rs.Rows.Count)
            {
                ...
                if (rs.Rows[i]["prenom"].ToString() != "")
                {
                    ...
                    {
                        Bloc newBloc = new Bloc(DateTime.ParseExact(rs3.Rows[j]["debut"].ToString(), "yyyy-MM-dd HH:mm:ss", null), DateTime.ParseExact(rs3.Rows[j]["fin"].ToString(), "yyyy-MM-dd HH:mm:ss", null), 0, Convert.ToInt32(rs3.Rows[j]["idPlage"].ToString()), Convert.ToInt32(rs3.Rows[i]["preset"].ToString()));
                    ...
                    {
                        Bloc newBloc = new Bloc(DateTime.ParseExact(rs4.Rows[j]["debut"].ToString(), "yyyy-MM-dd HH:mm:ss", null), DateTime.ParseExact(rs4.Rows[j]["fin"].ToString(), "yyyy-MM-dd HH:mm:ss", null), 0, Convert.ToInt32(rs4.Rows[j]["idPlage"].ToString()), Convert.ToInt32(rs4.Rows[i]["preset"].ToString()));
        ...
        public List<Bloc> loadBloc()
        {
            ...
            for (int i = 0; i < rsBloc.Rows.Count; i++)
            {
                ...
                Bloc newBloc = new Bloc(DateTime.ParseExact(rsBloc.Rows[i]["debut"].ToString(), "yyyy-MM-dd HH:mm:ss", null), DateTime.ParseExact(rsBloc.Rows[i]["fin"].ToString(), "yyyy-MM-dd HH:mm:ss", null), Convert.ToInt32(rsBloc.Rows[i]["idType"].ToString()), Convert.ToInt32(rsBloc.Rows[i]["idBlock"].ToString()), Convert.ToInt32(rsBloc.Rows[i]["preset"].ToString()));
